    ...
    <div class="w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow-md sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
        ...
        <form class="mt-5 space-y-6" action="/register" method="POST">
            ...
            <div>
                ...
                <input type="text" value="waduh" name="name" id="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white">
                <!-- @error("name")
            ...
            <div>
                ...
                <input type="text"value="waduh" name="username" id="username" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" >
                <!-- @error("username")
                    <p class="text-sm text-red-600">{{ $message }}</p>
                @enderror -->
            </div>
            <div>
                ...
                <input type="email" value="hello" name="email" id="email" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white">
                <!-- @error("email")
                     <p class="text-sm text-red-600">{{ $message }}</p>
                @enderror -->
            </div>
